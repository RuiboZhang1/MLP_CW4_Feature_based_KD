...
torchrun torchdistill/examples/image_classification.py --config torchdistill/configs/sample/cifar100/fitnet/resnet44-student-25k.yaml --log log/cifar100/fitnet/resnet44-student-25k.yaml --eval_period 10
